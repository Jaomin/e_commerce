...
<main>		
		...
		<div class="row">
			<div class=" all  col-xs-12 col-sm-10 col-md-12">
				<aside class="list  col-xs-12 col-sm-4 col-md-2">
					<ul>
...
<?php 
	...
	/*foreach($mylist as $ligne){

?>
		 <li><a href="/fantasy/index.php?page=<?php echo $ligne['name'] ?>">&nbsp&nbsp<?php echo strtoupper($ligne['name']) ?></a></li>
<?php
}*/
?>	 			
					</ul>
					<div class="infos col-xs-12  col-sm-4 col-md-12">
